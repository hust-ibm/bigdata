 ...
 * @author hu
 */
public class cbdio extends BreadthCrawler {
    ...
    public cbdio(String crawlPath, boolean autoParse) {
    ...
    //	proxys.add();
       ...
       // this.addSeed("http://news.hfut.edu.cn/list-1-1.html");
        this.addSeed("http://www.cbdio.com/");

        /*正则规则设置*/
        /*爬取符合 http://news.hfut.edu.cn/show-xxxxxxhtml的URL*/
        this.addRegex("http://www.cbdio.com/.*");
        /*不要爬取 jpg|png|gif*/
    ...
    public static void main(String[] args) throws Exception {
    	cbdio crawler = new cbdio("crawl", true);
        /*线程数*/
